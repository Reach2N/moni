        ...
        return (
          ...
          >
            <button
              ...
              className="flex min-h-14 w-full items-center gap-2.5 px-2.5 py-2 text-left sm:min-h-11 sm:py-0"
            >
              <span className="flex size-6 shrink-0 items-center justify-center">
                {badgeFor(row)}
              </span>
              <span className="flex min-w-0 flex-1 flex-col gap-0.5 sm:flex-row sm:items-center sm:gap-2">
                <span className="min-w-0 text-[13px] font-medium leading-snug text-ink sm:flex-1 sm:truncate">
                  {row.label}
                </span>
